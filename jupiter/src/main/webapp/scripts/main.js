(function() {
  ...
  /**
   * Variables
   * immediate implementation function, default. 
   * testing user 1111 password 2222
   */
   ...
   */
//  entrance function, all function would be inside, initialization function. keep users log in, validateSession(). 
  function init() {
  ...
  /**
   * Session: login, on session.
   */
  function validateSession() {
    onSessionInvalid(); // each function would make one thing.
